  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-2xl bg-purple-50 dark:bg-purple-950/40 border border-purple-200 dark:border-purple-800/60 text-xs text-purple-900 dark:text-purple-200 flex items-start gap-3">
        ...
        <div>
          <strong>How the AI Knowledge Engine Works:</strong> Whenever a visitor types a question in the portfolio chatbot, the server matches triggers against this custom knowledge base combined with real-time profile, project, and service records from your SQLite database.
        </div>
      </div>

...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ onNavigate }) => {
  ...
  const kpis = [
    ...
    },
    {
      ...
      value: counts.cvDownloads || 185,
      change: 'Direct Drive Clicks',
      icon: Download,
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-blue-100 text-sm max-w-xl">
              All portfolio sections are actively powered by your SQLite database. You can manage projects, update skills, moderate client reviews, and reply to client inquiries in real time.
            </p>
          </div>

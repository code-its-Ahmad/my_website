...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      playSuccess();
      toast.success(res.message || 'Message sent! Muhammad Ahmad will get back to you shortly.', {
        duration: 5000,
      });
      ...
      toast.error(err?.response?.data?.error || 'Failed to send message. Please try again or reach out via WhatsApp.');
    } finally {

  ...
  return (
    <footer className="relative bg-gray-950 text-white border-t border-gray-800/80 pt-16 pb-24 lg:pb-16 overflow-hidden select-none">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pb-10 border-b border-gray-800/80">
          {/* Brand & Status */}
          <div className="space-y-3">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-purple-600 flex items-center justify-center font-extrabold text-sm shadow-lg shadow-blue-500/25 border border-white/20">
                MA
              </div>
              <div>
          ...
          <div className="flex flex-col justify-center space-y-2.5">
            {onOpenTerminal && (
              <button
                ...
                className="w-full py-2.5 px-4 rounded-xl bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/30 text-cyan-300 hover:text-white text-xs font-mono font-bold flex items-center justify-center gap-2 transition-all active:scale-95 shadow-sm shadow-cyan-500/10"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              {quickLinks.map((link) => (
                <button
                  ...
                  onMouseEnter={playHover}
                  className="text-left text-xs text-gray-400 hover:text-cyan-400 transition-colors py-1 truncate"
                >
                  → {link.label}
                </button>
              ))}
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              <a
                ...
                rel="noreferrer"
                onMouseEnter={playHover}
                className="p-2.5 rounded-xl bg-gray-900 border border-gray-800 hover:border-gray-600 text-gray-300 hover:text-white transition-all hover:scale-105"
                title="GitHub"
              >
              ...
              <a
                ...
                rel="noreferrer"
                onMouseEnter={playHover}
                className="p-2.5 rounded-xl bg-gray-900 border border-gray-800 hover:border-blue-500/50 text-gray-300 hover:text-blue-400 transition-all hover:scale-105"
                title="LinkedIn"
              >
              ...
              <a
                ...
                rel="noreferrer"
                onMouseEnter={playHover}
                className="p-2.5 rounded-xl bg-gray-900 border border-gray-800 hover:border-emerald-500/50 text-gray-300 hover:text-emerald-400 transition-all hover:scale-105"
              ...
              <a
                href={`mailto:${email}`}
                onMouseEnter={playHover}
                className="p-2.5 rounded-xl bg-gray-900 border border-gray-800 hover:border-cyan-500/50 text-gray-300 hover:text-cyan-400 transition-all hover:scale-105"
                title="Email Direct"
              >
          ...
          {/* Scroll To Top Ring Action */}
          <div className="flex flex-col items-start md:items-end justify-center space-y-2">
            <button
              onClick={scrollToTop}
              onMouseEnter={playHover}
              className="group relative flex items-center gap-3 p-2.5 rounded-2xl bg-gray-900/80 hover:bg-gray-800 border border-gray-800 hover:border-cyan-500/40 text-xs font-semibold text-gray-300 hover:text-white transition-all active:scale-95"
            >
              ...
              <div className="relative w-8 h-8 flex items-center justify-center">
                ...
                <ArrowUp className="w-3.5 h-3.5 absolute text-cyan-400 group-hover:-translate-y-0.5 transition-transform" />
              </div>
        ...
        <div className="pt-8 border-t border-gray-800/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400 font-mono">

...
import { Award, ExternalLink, ShieldCheck, X, Sparkles, CheckCircle2, Search, Filter } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-7xl mx-auto w-full space-y-8 sm:space-y-10">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 p-3.5 sm:p-4 rounded-3xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-2xl border border-gray-200 dark:border-gray-800 shadow-xl">
          {/* Issuer Chips */}
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full pl-8 pr-8 py-1.5 text-xs bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 dark:text-white"
            />
            {searchQuery && (
              <button
              ...
              >
                ...
                >
                  <div
                    ...
                    onMouseEnter={playHover}
                    className="h-full p-6 sm:p-7 rounded-3xl bg-white/85 dark:bg-gray-900/85 backdrop-blur-xl border border-gray-200 dark:border-gray-800 hover:border-blue-500/50 shadow-xl flex flex-col justify-between space-y-4 transition-all cursor-pointer group"
                  >
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-amber-400 to-orange-500 text-white flex items-center justify-center shadow-md shadow-amber-500/20 group-hover:scale-105 transition-transform">
                          <Award className="w-5 h-5" />
                        </div>

                        <span className="px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 border border-blue-100 dark:border-blue-900/60">
                          {cert.year}
                        </span>
                      </div>
                      ...
                      <div>
                        ...
                        <h3 className="font-extrabold text-base sm:text-lg text-gray-900 dark:text-white mt-0.5 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors line-clamp-1">
                          {cert.title}
                        </h3>
                      </div>

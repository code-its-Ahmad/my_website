  ...
  return (
    <div className="relative min-h-dvh overflow-x-clip bg-gray-50 text-gray-900 transition-colors duration-300 selection:bg-cyan-500 selection:text-black dark:bg-gray-950 dark:text-white">
      ...
      <main className="relative z-10">
        ...
        <LazySection minHeight="100vh" skeletonVariant="default">
          <About />
        </LazySection>

        <LazySection minHeight="100vh" skeletonVariant="cards">
          <Projects />
        </LazySection>
        ...
        <LazySection minHeight="80vh" skeletonVariant="timeline">
          <Experience />
        </LazySection>

        <LazySection minHeight="90vh" skeletonVariant="cards">
          <Services />
        </LazySection>

        <LazySection minHeight="80vh" skeletonVariant="cards">
          <Certificates />
        </LazySection>
        ...
        <LazySection minHeight="90vh" skeletonVariant="default">
          <Contact />
        </LazySection>
      </main>
